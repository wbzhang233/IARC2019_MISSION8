...
public class OpencvTestActivity extends Activity {
    ...
    private void convertGray() {
        ...
        Imgproc.threshold(dst,threshold_out,245,255,Imgproc.THRESH_BINARY);
        Utils.matToBitmap(threshold_out, selectbp);
        myImageView1.setImageBitmap(selectbp);
    }
